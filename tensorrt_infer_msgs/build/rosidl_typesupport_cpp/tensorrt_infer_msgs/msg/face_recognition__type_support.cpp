...
static const _FaceRecognition_type_support_symbol_names_t _FaceRecognition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tensorrt_infer_msgs, msg, FaceRecognition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tensorrt_infer_msgs, msg, FaceRecognition)),
  }
};
...
{
  return &::tensorrt_infer_msgs::msg::rosidl_typesupport_cpp::FaceRecognition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tensorrt_infer_msgs, msg, FaceRecognition)() {
  return get_message_type_support_handle<tensorrt_infer_msgs::msg::FaceRecognition>();
}
