...
/* @@protoc_insertion_point(class_definition:google.api.TypeReference) */ {
 ...
 protected:
  ...
  TypeReference(::google::protobuf::Arena* arena, TypeReference&& from) noexcept
      : TypeReference(arena) {
    *this = ::std::move(from);
  }
...
/* @@protoc_insertion_point(class_definition:google.api.FieldInfo) */ {
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::google::api::TypeReference>* mutable_referenced_types();
...
extern ::google::protobuf::internal::ExtensionIdentifier<
    ::google::protobuf::FieldOptions, ::google::protobuf::internal::MessageTypeTraits< ::google::api::FieldInfo >, 11,
    false>
    field_info;
