...
inline PROTOBUF_NDEBUG_INLINE HttpBody::Impl_::Impl_(
    ...
    const Impl_& from, const ::google::api::HttpBody& from_msg)
...
void HttpBody::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
