...
/* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.Explain.ExprStep) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR Explain_ExprStep(
 ...
 protected:
  ...
  Explain_ExprStep(::google::protobuf::Arena* arena, Explain_ExprStep&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.Explain) */ {
 public:
  ...
  ~Explain() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR Explain(
      ::google::protobuf::internal::ConstantInitialized);
 ...
 protected:
  ...
  Explain(::google::protobuf::Arena* arena, Explain&& from) noexcept
      : Explain(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const final;
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::google::api::expr::v1alpha1::Explain_ExprStep>* mutable_expr_steps();
