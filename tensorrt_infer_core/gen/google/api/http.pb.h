...
class CustomHttpPattern final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.api.CustomHttpPattern) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CustomHttpPattern(
 ...
 protected:
  ...
  CustomHttpPattern(::google::protobuf::Arena* arena, CustomHttpPattern&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:google.api.HttpRule) */ {
 ...
 protected:
  ...
  HttpRule(::google::protobuf::Arena* arena, HttpRule&& from) noexcept
      : HttpRule(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const final;
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::google::api::HttpRule>* mutable_additional_bindings();
  ...
  void set_allocated_response_body(std::string* value);
...
class Http final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:google.api.Http) */ {
 public:
  inline Http() : Http(nullptr) {}
  ~Http() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR Http(
      ::google::protobuf::internal::ConstantInitialized);
 ...
 protected:
  ...
  Http(::google::protobuf::Arena* arena, Http&& from) noexcept
      : Http(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const final;
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::google::api::HttpRule>* mutable_rules();
...
inline std::string* HttpRule::mutable_response_body() ABSL_ATTRIBUTE_LIFETIME_BOUND {
