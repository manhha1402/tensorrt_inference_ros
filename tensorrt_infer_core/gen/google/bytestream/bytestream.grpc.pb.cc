...
std::unique_ptr< ByteStream::Stub> ByteStream::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< ByteStream::Stub> stub(new ByteStream::Stub(channel, options));
  return stub;
}

ByteStream::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_Read_(ByteStream_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_Write_(ByteStream_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
  , rpcmethod_QueryWriteStatus_(ByteStream_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void ByteStream::Stub::async::Read(::grpc::ClientContext* context, const ::google::bytestream::ReadRequest* request, ::grpc::ClientReadReactor< ::google::bytestream::ReadResponse>* reactor) {
...
void ByteStream::Stub::async::Write(::grpc::ClientContext* context, ::google::bytestream::WriteResponse* response, ::grpc::ClientWriteReactor< ::google::bytestream::WriteRequest>* reactor) {
...
void ByteStream::Stub::async::QueryWriteStatus(::grpc::ClientContext* context, const ::google::bytestream::QueryWriteStatusRequest* request, ::google::bytestream::QueryWriteStatusResponse* response, std::function<void(::grpc::Status)> f) {
...
void ByteStream::Stub::async::QueryWriteStatus(::grpc::ClientContext* context, const ::google::bytestream::QueryWriteStatusRequest* request, ::google::bytestream::QueryWriteStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) {
